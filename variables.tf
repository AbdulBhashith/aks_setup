...
variable "default_node_pool" {
  ...
  description = "Default Node Pool Definition. Must be defined"
   default = {
    ...
    os_disk_size_gb       = 30
    subnet_id             = "/subscriptions/86c82398-3448-43c6-9f4b-954558c30c5a/resourceGroups/abdulRG/providers/Microsoft.Network/virtualNetworks/abdulVN/subnets/abdulSN"
...
variable "log_analytics_workspace_id" {
  ...
  default ="/subscriptions/86c82398-3448-43c6-9f4b-954558c30c5a/resourceGroups/abdulRG/providers/Microsoft.OperationalInsights/workspaces/WS-test"
}
